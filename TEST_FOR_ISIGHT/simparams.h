...
static constexpr int NCOND = 6 + 1, NINEQ = NDIV + 1;//THE QUANTITY OF CONDITIONS AND INEQUALITIES
...
const string file_name = "test20210112vbase" + to_string(vbase) + "Ver7WithConds";
