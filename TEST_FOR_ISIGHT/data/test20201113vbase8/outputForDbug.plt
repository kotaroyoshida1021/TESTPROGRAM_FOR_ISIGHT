...
set size ratio -1
plot "shape.txt" using 1:2 with lines linewidth 1.5 title "optshape", "wire.txt" using 1:2 with lines linewidth 1.5 title "wireshape"
...
#set size ratio -1
plot "functions.txt" using 1:3 with lines linewidth 1.5 title "omgeta"
set terminal pngcairo crop
